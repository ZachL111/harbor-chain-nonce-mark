"""Regression checks for the harbor-chain-nonce-mark casebook."""
...
from casebook.harness import assert_expected, harbor_chain_nonce_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(harbor_chain_nonce_mark_summary(), assert_expected())
